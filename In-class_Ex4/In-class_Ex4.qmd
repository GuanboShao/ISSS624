...
In this in-class exercise, I add in additional notes to hands-on exercise 4 and learn how to use geographically weighted regression (GWR) to build [hedonic pricing](https://www.investopedia.com/terms/h/hedonicpricing.asp) models.
...
[`tmap_options(check.and.fix = TRUE)` is used to check and fix invalid/broken polygons.]{.underline}
...
[Use *condo_resale* instead of *condo_resale.sf* because *condo_resale.sf* has geometry fields and this will give error.]{.underline}
...
[For Model summary, look at Adjusted R square value.]{.underline}

[For ANOVA, look at Sig. values.]{.underline}

[For Parameter estimates, compare Sig. values with 0.05.]{.underline}

[From Parameter estimates table, for any 1 unit increase in Area, the selling price **increases** by 12777.523; for any 1 unit increase in Age, the selling price **reduces** by 24687.739.]{.underline}
...
[Use \` \` to quote field name.]{.underline}
...
[If location data is already projected, set *longlat = FALSE*]{.underline}
...
[Compare AICc values of the two results table AICc: 42967.14 vs AICc (GWR book, Fotheringham, et al. 2002, p. 61, eq 2.33): 42263.61.]{.underline}
