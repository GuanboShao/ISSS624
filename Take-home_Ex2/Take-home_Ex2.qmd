...
In this section, I will perform hierarchical cluster analysis.
...
The code chunk below uses `cutree()` of **R Base** to derive a 3-cluster model after examining the dendragram above.
...
Based on the graphs above, in `hclustgeo()` alpha is set to 0.3.
